...
Protracker.prototype.createContext = function()
{
  ...
  if (!this.context) {
       alert('Sorry, no Web Audio API in this browser');
       return;
  }
  if (this.analyserEnable) {
      try {
...
// stop playback
Protracker.prototype.stop = function(s)
{
  this.playing=false;
  s && this.onStop(s);
...
Protracker.prototype.load = function(url, callback)
{
